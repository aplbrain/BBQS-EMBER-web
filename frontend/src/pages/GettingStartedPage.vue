            ...
            <q-item-section>
              ...
              <q-item-label>
                ...
                <a href="https://dandi.emberarchive.org" target="_blank" class="link">
                  EMBER-DANDI portal
                </a>. At this time, there is no login option on the main EMBER site
                (<a href="https://emberarchive.org" target="_blank" class="link">emberarchive.org</a>).
                Users with a <code>.edu</code> email address will be automatically approved. All others
                will require manual approval by a member of the EMBER team.
              </q-item-label>
            </q-item-section>
          </q-item>
